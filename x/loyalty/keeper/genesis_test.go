...
func TestGenesis(t *testing.T) {
	genesisState := types.GenesisState{
		...
		CreatorallowlistMap: []types.Creatorallowlist{{Address: "0"}, {Address: "1"}}, VerifiedtokenMap: []types.Verifiedtoken{{Denom: "0"}, {Denom: "1"}}, RewardaccrualMap: []types.Rewardaccrual{{Key: "0"}, {Key: "1"}}}
